...
if errorlevel 1 (
	echo Python not installed or defined in enviroment path, please install manually...
	goto end
)

python -c "import pandas" >nul 2>&1 
if errorlevel 1 (
	echo Pandas not found. "NOTE:: Pandas is required in order for this script to function."
...
:end
echo Thank you for using KJ's RV Script! :^)
endlocal
pause
